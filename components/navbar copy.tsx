    ...
    return (
        <>
            <main className="flex flex-col items-center justify-start px-4">
                {isAddressVisible && (
                    <div className="fixed flex items-center justify-between top-0 left-0 right-0 bg-white text-black px-4 md:px-16">
                        <div>
                            <ul className="flex items-center space-x-4">
                                <li className="flex items-center space-x-1">
                                    <Phone className="h-4 w-4" />
                                    <span>0384225294</span>
                                </li>
                                <li className="flex items-center space-x-1">
                                    <Mail className="h-4 w-4 mt-1" />
                                    <span>nguyenvantanphat.it@gmail.com</span>
                                </li>
                                <li className="flex items-center space-x-1">
                ...
                <div className={`flex fixed ${isAddressVisible ? 'top-7' : 'top-0'} px-4 md:px-16 left-0 right-0 bg-[#0A0A0A] text-white p-6 items-center justify-between`}>
                    <Link href="/">
                        <div>Tấn Phát</div>
                    </Link>
                    <div>
                        ...
                        <ul className="flex flex-col space-y-4">
                            {NAV_ITEMS.map((navItem) => (
                                <li key={navItem.label}>
                                    <button
                                        className="text-sm py-2 px-4 flex cursor-pointer group transition-colors duration-300 items-center justify-between text-white"
                                        onClick={() => {
                                            if (navItem.subMenus) {
                      ...
                      `}
                                    ...
                                    {openMenu === navItem.label && navItem.subMenus && (
                                        <div className="pl-4">
                                            {navItem.subMenus.map((sub) => (
                                                <div key={sub.title}>
                                                    <h3 className="mb-2 text-sm font-medium capitalize text-white/50">
                                                        {sub.title}
                                                    </h3>
